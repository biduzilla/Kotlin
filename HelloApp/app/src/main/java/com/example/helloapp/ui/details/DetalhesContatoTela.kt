...
import com.example.helloapp.ui.components.DetalhesContatoAppBar
        ...
        Column(
            ...
            Row(
                ...
                Column(
                    ...
                    Text(
                        text = stringResource(id = R.string.ligar),
...
@Preview
@Composable
fun DetalhesContatoTelaPreview() {
