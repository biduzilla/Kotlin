...
class AnuncioAdapter(private val anuncioList:MutableList<Anuncio>, private val OnClick:OnClickListener)  :RecyclerView.Adapter<AnuncioAdapter.ViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
       val view:View = LayoutInflater.from(parent.context).inflate(R.layout.anuncio_item,parent,false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvPreco.text = anuncio.valor.toString()
        holder.tvLocal.text = "${anuncio.local!!.localidade},   ${anuncio.local!!.bairro} - DDD ${anuncio.local!!.ddd}"
